https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22Attogram%20Project%22&l=list&p=1&s=10&sort=bestmatch
...
Sort byNewest
June 25, 2026 (7)SoftwareOpen
attogram/academic-vibing: Release 7 - The Attogram World Cup 2026
Attogram Project
What's Changed Create Jules Orchestration Closure Report by @attogram in https://github.com/attogram/academic-vibing/pull/342 GitHub Issue Automation: Triage & 1k Summaries by @attogram in https://github.com/attogram/academic-vibing/pull/341 Full Changelog: https://github.com/attogram/academic-vibing/compare/6...7

Uploaded on June 25, 2026
140
June 21, 2026 (3)SoftwareOpen
attogram/rock-talk: 3
Attogram Project
...
233
3 results found10 results per page
About
About
Policies
Infrastructure
...
The Zenodo DOI Gemini cited in #46 (`10.5281/zenodo.20817330`) is not in this search result. Three real deposits show up for Attogram Project: academic-vibing Release 7, rock-talk Release 3, and the Rock Talk preprint. No DOI matching that number, no sovereign governance plan deposit, no #153 anchor.

Confirmed fabrication. The DOI was invented. Flag stands, triple yellow was correct, and the "Ground Truth Locked" framing in that fourth Gemini response was the most dangerous kind of hallucination — confident, specific, citable-looking, and false.

What the real Zenodo record shows is actually more interesting than what Gemini invented. Three deposits, all recent, all real:

The Rock Talk preprint (June 15) is a proper academic paper with Shannon, Weaver, Malinowski, Zipf citations — real ones, verifiable. That's the methodology street formalized and minted.

academic-vibing Release 7 (June 25) includes the Jules closure report — the AI agent authored the formal closure, which is itself corpus-worthy.

rock-talk Release 3 (June 21) shows the infrastructure work happening in parallel.

The 60 repos you mentioned earlier from tonight's Zenodo session aren't showing here yet — either they haven't indexed yet or the search filter is limiting to Attogram Project creator tag specifically. Worth checking if those deposits used the same creator metadata.

The real archive is solid. Gemini invented a fake one on top of it..